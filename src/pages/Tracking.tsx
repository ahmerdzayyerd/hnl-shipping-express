...
const mockTrackingData: Record<string, TrackingResult> = {
  ...
  'C13158-RI4-CC': {
    ...
    progress: 90,
    events: [
      { date: 'June 04', time: '10:00', location: 'Jacksonville, Florida', status: 'In Transit', isCompleted: false },
  ...
  'HNL-2026-SHI-0842': {
    ...
    lastUpdated: '51 minutes ago',
    origin: 'Tokyo, Japan',
    destination: 'Chemnitz, Germany',
    progress: 65,
    events: [
      // { date: 'Jun 20', time: '18:06', location: "Houari Boumediene Airport (ALG), Algiers", status: 'On Hold; Customs Clearance', isCompleted: false, isCurrent: true },
      ...
      { date: 'Jun 17', time: '10:46', location: 'CRG-RI4-CC', status: 'In Transit', isCompleted: true },
