...
const mockTrackingData: Record<string, TrackingResult> = {
  ...
  'HNL21385535': {
    ...
    events: [
      // { date: 'Jan 20', time: '10:45', location: 'Chicago, IL', status: 'Delivered', isCompleted: true, isCurrent: true },
      { date: 'Apr 21', time: '07:30', location: 'A350-900ULR, Cargo', status: 'In Transit', isCompleted: true },
      ...
      { date: 'Apr 15', time: '23:00', location: 'A350-900ULR, Cargo', status: 'In Transit', isCompleted: true },
      { date: 'Apr 14', time: '07:22', location: 'A350-900ULR, Cargo', status: 'In Transit', isCompleted: true },
